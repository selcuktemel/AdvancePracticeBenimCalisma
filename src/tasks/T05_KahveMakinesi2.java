...
public class T05_KahveMakinesi2 {
...
HERKESE KOLAY GELSİN !! :)
        ...
        List<String> kahveCesitleri = new ArrayList<>(Arrays.asList("Türk Kahvesi", "Filtre Kahve", "Espresso"));


        for (int i = 0; i < kahveCesitleri.size(); i++) {
            if (kahveCesitleri.get(i).equalsIgnoreCase("Türk Kahvesi")) {
                System.out.println(kahveCesitleri.get(i) + " hazirlaniyor");
